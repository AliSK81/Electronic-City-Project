...
public class ShippingPortsTable implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        docksCOL.setCellValueFactory(new PropertyValueFactory<>("docks"));
        addressCOL.setCellValueFactory(new PropertyValueFactory<>("address"));

        shippingPortsTable.getItems().addAll(Entry.getCity().getShippingPorts());
    }
